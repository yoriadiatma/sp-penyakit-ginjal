...
<title>Hasil Konsultasi Sistem Pakar Penyakit Ginjal</title><body onload=javascript:window:print()>
...
$result312= mysql_query($query312) or die('Error');
while($data312 = mysql_fetch_array($result312))
{
//panggil data dari tabel, jadikan variabel
...
?>
    ...
    <tr >
      <td><strong>Dari gejala tersebut anda Menderi Penyakit Ginjal dengan tingkat Keyakinan <?php echo"$data51[persen]"; ?> %</strong></td>
    </tr>
    <tr >
