...
$querysave = "INSERT INTO tblkonsultasi       
          (tgl,id_pasien,id_gangguan,persen) 
VALUES ('$date','$_SESSION[namauser]','$_GET[gangguan]','$_GET[persen]')";
...
$query3 = "SELECT * FROM tblgangguan where idgangguan = '$_GET[gangguan]' "; 
...
$query = "SELECT * FROM tblgangguanterapi where idgangguan = '$_GET[gangguan]'"; 
